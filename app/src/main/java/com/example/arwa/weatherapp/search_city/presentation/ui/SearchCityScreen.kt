package com.example.arwa.weatherapp.search_city.presentation.ui
...
import com.example.arwa.weatherapp.search_city.presentation.viewmodel.CityViewModel
...
fun SearchCityScreen(cityViewModel: CityViewModel = hiltViewModel(), navController: NavController) {
    ...
    } else if (cityState.city != null) {
        navController.navigate(
            Screen.WeatherScreen.withArgs(
                cityState.city.lat.toString(),
                cityState.city.long.toString()
            )
        )
    }
}
